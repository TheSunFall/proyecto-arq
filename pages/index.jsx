  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const ultimaLectura = result.last10Values?.slice(-1)[0];
        if (ultimaLectura) {
  ...
  return (
    <Layout>
      <div className="w-10/12 h-5/6 grid grid-cols-2 grid-rows-[20%_40%_40%] gap-4 mx-auto py-8">
        <div className="col-span-2 max-h-24 text-lg"><h1 style={{ textAlign: "center" }}>Datos de la última lectura</h1></div>
